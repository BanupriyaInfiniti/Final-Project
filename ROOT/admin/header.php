...
<header class="app-header">
    <a class="app-header__logo" href="dashboard.php"><?php echo $CmsData['title'] ?></a>
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                ...
                <li>
                    <form method="post" action="index.php">
                        ...
                        <a class="dropdown-item" onclick="formSubmit()" href="#"><i class="fa fa-sign-out fa-lg"></i> Logout</a>
                    </form>
                    <script>
                        function formSubmit() {
